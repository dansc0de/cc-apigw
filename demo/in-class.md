...
- delete the `demo-api` REST API
- delete `mock-tasks` and `mock-authorizer` Lambdas
- delete IAM execution role
- delete ECR repositories (`apigw/tasks`, `apigw/authorizer`)
- CloudWatch logs auto-delete
